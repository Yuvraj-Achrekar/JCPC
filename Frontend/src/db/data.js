...
export const jioPcOpenIssuePieChart = [
  ...
  { id: 1, value: 78, label: "Critical", color: "#fef08a" },
  { id: 2, value: 138, label: "Major", color: "#fed7aa" },
  { id: 3, value: 33, label: "Normal", color: "#e9d5ff" },
  { id: 4, value: 3, label: "Minor", color: "#bae6fd" },
];

export const launchBlockerIssuePieChart = [
  { id: 0, value: 1, label: "Blocker", color: "#fecaca" },
  { id: 1, value: 19, label: "Critical", color: "#fef08a" },
  { id: 2, value: 10, label: "Major", color: "#fed7aa" },
